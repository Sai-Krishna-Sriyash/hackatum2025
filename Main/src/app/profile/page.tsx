		...
		return (
			<div className="space-y-4">
				<button
					...
					className="text-[#2D7A83] text-sm font-bold flex items-center gap-1"
				>
		...
		return (
			<div className="space-y-4">
				...
				<div className="bg-white p-4 rounded-xl border flex items-center gap-3">
					<div className="bg-[#163C5D] text-white p-2 rounded">
						<CreditCard size={20} />
					</div>
					<div className="flex-1">
						<p className="font-bold text-[#163C5D]">Visa 4242</p>
					</div>
					<Check className="text-[#67B99A]" />
				</div>
			</div>
		);
	...
	return (
		<div className="space-y-6">
			<div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E6F4F1] flex items-center gap-6">
				<div className="w-24 h-24 rounded-full p-1 border-2 border-[#67B99A]">
					<img src={user.avatar} className="w-full h-full rounded-full object-cover" alt="Profile" />
				</div>
				<div>
					<h2 className="text-2xl font-bold text-[#163C5D]">{user.name}</h2>
					<p className="text-[#2D7A83] flex items-center gap-1">
			...
			<div className="space-y-4">
				<button
					...
					className="w-full bg-white p-4 rounded-xl flex justify-between items-center text-[#163C5D] hover:bg-[#E6F4F1] transition shadow-sm"
				>
				...
				<button
					...
					className="w-full bg-white p-4 rounded-xl flex justify-between items-center text-[#163C5D] hover:bg-[#E6F4F1] transition shadow-sm"
				>
					Payment Methods <ChevronRight size={16} />
				</button>
